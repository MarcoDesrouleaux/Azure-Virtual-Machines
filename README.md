...
1. Click on 'Create a resource' in the left sidebar.
2. Click on 'Compute,' then select 'Virtual Machine.'
![Create VM]<img src="https://i.imgur.com/DJmEXEB.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>

### 2.2 Provide Basic Information
...
![Basic Info]<img src="https://i.imgur.com/DJmEXEB.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>

## Step 3: Choose the Virtual Machine Image
